...
function drawGarden() {
    ...
    $("#content").css("width", $loveHeart.width() + $("#code").width() + 50);
    $("#content").css("height", Math.max($loveHeart.height(), $("#code").height()));
    $("#content").css("margin-top", Math.max(($window.height() - $("#content").height()) / 2, 10));
    $("#content").css("margin-left", Math.max(($window.width() - $("#content").width()) / 2 - 20, 10));
...
function startHeartAnimation(interval) {
    var angle = 10;
    var heart = new Array();
...
function adjustWordsPosition() {
    ...
    $('#words').css("top", $("#garden").position().top + 235);
